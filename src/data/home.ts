...
export const personalInfo = {
  ...
  details: [
    ...
    {
      description: `In addition to my frontend expertise, I have hands on experience developing RESTful APIs, working with PostgreSQL and MySQL databases, implementing authentication and authorization mechanisms, containerizing applications with Docker, and collaborating across the full software development lifecycle. This broader technical foundation allows me to contribute effectively to both frontend and backend initiatives while working closely with cross-functional teams.`
    },
    {
